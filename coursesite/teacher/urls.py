...
from teacher.views import lesson
...
from teacher.views import access
...
urlpatterns = patterns('',
    ...
    # Access
    url(r'^teacher/course/(\d+)/access$', access.access_page),
    url(r'^teacher/course/(\d+)/access_set', access.access_set),
    ...
    # Lesson
    url(r'^teacher/course/(\d+)/lessons$', lesson.lesson_page),
    url(r'^teacher/course/(\d+)/lesson_table$', lesson.lesson_table),
    url(r'^teacher/course/(\d+)/lesson_modal$', lesson.lesson_modal),
    url(r'^teacher/course/(\d+)/hwlesson_modal$', lesson.hwlesson_modal),
    url(r'^teacher/course/(\d+)/save_lesson$', lesson.save_lesson),
    url(r'^teacher/course/(\d+)/delete_lesson$', lesson.delete_lesson),
    url(r'^teacher/course/(\d+)/save_hw$', lesson.save_hw),

    # Lecture
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lectures$', lecture.lectures_page),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lectures_table$', lecture.lectures_table),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lecture_modal$', lecture.lecture_modal),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/save_lecture$', lecture.save_lecture),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/delete_lecture$', lecture.delete_lecture),

    # Lecture Note(s)
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lecture/(\d+)/notes$', lecture_note.lecture_notes_page),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lecture/(\d+)/lecture_notes_table$', lecture_note.lecture_notes_table),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lecture/(\d+)/lecture_note_modal$', lecture_note.lecture_note_modal),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lecture/(\d+)/save_lecture_note$', lecture_note.save_lecture_note),
    url(r'^teacher/course/(\d+)/lessons/(\d+)/lecture/(\d+)/delete_lecture_note$', lecture_note.delete_lecture_note),
