...
def lecture_notes_page(request, course_id, lesson_id, lecture_id):
...
@login_required(login_url='/landpage')
def lecture_notes_table(request, course_id, lesson_id, lecture_id):
    course = Course.objects.get(id=course_id)
    teacher = Teacher.objects.get(user=request.user)
    lecture = Lecture.objects.get(lecture_id=lecture_id)
    lesson = Lesson.objects.get(lesson_id=lesson_id)
...
@login_required(login_url='/landpage')
def lecture_note_modal(request, course_id, lesson_id, lecture_id):
...
@login_required(login_url='/landpage')
def save_lecture_note(request, course_id, lesson_id, lecture_id):
...
@login_required(login_url='/landpage')
def delete_lecture_note(request, course_id, lesson_id, lecture_id):
