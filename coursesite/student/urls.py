...
from student.views import lesson
...
urlpatterns = patterns('',
    ...
    # Lesson
    url(r'^course/(\d+)/lessons$', lesson.lessons_page),
    url(r'^course/(\d+)/lesson$', lesson.lesson),
    url(r'^course/(\d+)/lessons/lesson_table$', lesson.lesson_table),
    url(r'^course/(\d+)/lessons/(\d+)/view_lesson_hw$', lesson.view_lesson_hw),
    url(r'^course/(\d+)/lessons/(\d+)/sendhwlesson_modal$', lesson.studenthw_modal),
    url(r'^course/(\d+)/lessons/(\d+)/save_hw_student$', lesson.save_hw),

    # Lecture
    url(r'^course/(\d+)/lessons/(\d+)/lectures$', lecture.lectures_page),
    url(r'^course/(\d+)/lessons/(\d+)/lecture$', lecture.lecture),
                       
    # Lecture Notes
    url(r'^course/(\d+)/lessons/(\d+)/lecture/(\d+)/notes$', lecture_note.lecture_notes_page),
    url(r'^course/(\d+)/lessons/(\d+)/lecture/(\d+)/view_lecture_note$', lecture_note.view_lecture_note),
