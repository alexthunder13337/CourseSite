...
class PathAndRename(object):
    ...
    def __call__(self, instance, filename):
        ...
        return os.path.join(self.path, instance.student.user.first_name + ' ' + instance.student.user.last_name + ' ' + instance.lesson.course.title +
                            ' ' + instance.lesson.title + ' ' + filename)


path_and_rename = PathAndRename("students/homework")
...
class Course(models.Model):
    ...
    status = models.PositiveSmallIntegerField(default=settings.COURSE_AVAILABLE_STATUS)
    image = models.ImageField(upload_to='uploads', null=True, blank=True)
    students = models.ManyToManyField(Student)
    teacher = models.ForeignKey(Teacher)
    tier1_students = models.ManyToManyField(Student, related_name='tier1', blank=True, null=True)
    tier2_students = models.ManyToManyField(Student, related_name='tier2', blank=True, null=True)
...
class Homework(models.Model):
    ...
    file = models.FileField(upload_to='homeworks', blank=False)
    answers = models.FileField(upload_to='answers', blank=False)
    speaking = models.FileField(upload_to='speaking', blank=False)
...
class SendHomework(models.Model):
    student_hw_id = models.AutoField(primary_key=True)
    student = models.ForeignKey(Student)
    lesson = models.ForeignKey(Lesson)
    file = models.FileField(upload_to=path_and_rename, blank=False)
    ...
    def __str__(self):
        return self.student.user.first_name + ' ' + self.student.user.last_name + ' - ' + self.lesson.title
...
class Lecture(models.Model):
    ...
    videofile = models.FileField(upload_to='lectures/', null=True, blank=True)
    ...
    notes = models.ManyToManyField(FileUpload, null=True, blank=True)
    ...
    def __str__(self):
        return ' Lecture: ' + str(self.lecture_num) + ' Title: ' + self.title;
